...
import { type Customer } from "../../services/apiCustomers";
...
function PersonalInfo({ onCloseModal }: PersonalInfoProps) {
  ...
  const { createOrder, isPending: isSubmitting } = useBooking();
  ...
  return (
    ...
    >
      ...
      >
        <select
          className="text-2xl py-3 px-5 border-2 border-solid border-gray-300 text-gray-700 dark:text-slate-200 bg-gray-100 dark:bg-gray-600 rounded-sm font-semibold shadow-sm"
