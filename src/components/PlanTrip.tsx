        ...
        <Container>
          <div className="flex flex-col">
            <div className="my-0 mx-auto text-center text-gray-800 dark:text-slate-100">
              ...
              <h2 className="mx-0 mt-5 ml-12 dark:text-slate-100">Quick & easy car rental</h2>
            </div>
            ...
            <GridBox>
              ...
              <div className="text-center py-4 px-4 md:px-24 flex flex-col items-center">
                <img src={Contact} alt="icon_img" className="w-64 h-auto" />
              ...
              <div className="text-center py-4 px-4 md:px-24 flex flex-col items-center">
                <img src={Drive} alt="icon_img" className="w-64 h-auto" />
