  ...
  return (
    <>
      <section
        ...
        style={{
          backgroundImage: 'url("/src/assets/chooseUs/bg.png")',
              ...
              <div className="flex flex-col lg:flex-row items-center text-center gap-20 justify-around mt-12 w-full">
                ...
                <div className="flex flex-col gap-16 max-w-[44rem]">
                  <div className="flex flex-col items-center md:flex-row md:items-start">
                    <img src={Box1} className="w-44 h-44 mr-4" />
                  ...
                  <div className="flex flex-col items-center md:flex-row md:items-start">
                    <img src={Box2} className="w-44 h-44 mr-4" />
                  ...
                  <div className="flex flex-col items-center md:flex-row md:items-start">
                    <img src={Box3} className="w-44 h-44 mr-4" />
