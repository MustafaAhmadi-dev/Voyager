        ...
        <Container>
          <div className="flex flex-col">
            <div className="flex flex-col my-0 mx-auto text-center md:w-[70rem] mb-20">
              ...
              <h2 className="text-4xl mb-6 dark:text-slate-100">Client's Testimonials</h2>
            ...
            <div className="flex justify-center gap-12 w-full p-0 lg:p-12">
              <div className="bg-white dark:bg-gray-800 shadow-xl relative py-20 px-12 md:w-[54rem]">
